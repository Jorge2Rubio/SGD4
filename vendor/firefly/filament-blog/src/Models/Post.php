                    ...
                    Fieldset::make('Feature Image')
                        ->schema([
                            FileUpload::make('cover_photo_path')
                                ->label('Cover Photo')
                                ->disk('public') // ✅ Store under 'public' disk
                                ->directory('blog-feature-images') // ✅ Clean and relative
                                ->hint('This cover image is used in your blog post as a feature image. Recommended image size: 1200x628.')
                                ->image()
                                ->preserveFilenames()
                                ->imageEditor()
                                ->maxSize(1024 * 5)
